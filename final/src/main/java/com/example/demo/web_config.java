...
public class web_config implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/images/**").addResourceLocations("file:/root/final_images/"); 
		registry.addResourceHandler("/final/**").addResourceLocations("file:/root/chatting/");
