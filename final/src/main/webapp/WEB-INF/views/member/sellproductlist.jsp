		...
		<div class="right">
			<div class="product_items">
				...
				<!-- 	<div class="product_item">
						...
						<div>
						<c:if test="${p.product_sell == 1 }"><img alt="등록된 이미지 없음" src="/images/soldout.png"  OnClick="location.href ='productdetail?product_num=${p.product_num}'" style="cursor: pointer;"></c:if>
						<c:if test="${p.product_sell == 0 }">
							<c:if test="${not empty p.image_path }"><img alt="등록된 이미지 없음" src="/images/${p.image_path}"  OnClick="location.href ='productdetail?product_num=${p.product_num}'" style="cursor: pointer;"></c:if>
